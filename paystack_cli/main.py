...
app.add_typer(charge_app, name="charge", help="The `charge` subcommand interacts with Charge API allows and you to configure a payment channel of your choice when initiating a payment.")
