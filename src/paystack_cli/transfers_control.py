...
@colorized_print
@override_output
def get_balance_ledger(json: bool = False, data_only: bool = False):
...
@override_output
def resend_otp(
    transfer_code: str, reason: Reason, json: bool = False, data_only: bool = False
):
...
@colorized_print
@override_output
def enable_otp(json: bool = False, data_only: bool = False):
...
@colorized_print
@override_output
def disable_otp(json: bool = False, data_only: bool = False):
...
@colorized_print
@override_output
def check_balance(json: bool = False, data_only: bool = False):
...
@colorized_print
@override_output
def finalize_disable_otp(otp: str, json: bool = False, data_only: bool = False):
